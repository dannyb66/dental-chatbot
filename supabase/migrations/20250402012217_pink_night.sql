/*
  # Family Relationships and Appointments Schema Update
  ...
  2. Changes
    ...
    - Add `is_primary` to patients table
    - Add index for family group lookups

  3. Security
    - Enable RLS on family_relationships table
    - Add policies for viewing and managing family relationships
    - Update appointment policies for family access

  4. Functions
    - Add function to find consecutive available slots
*/
